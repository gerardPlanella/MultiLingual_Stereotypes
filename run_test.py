...
<<<<<<< HEAD
    parser.add_argument('--social_groups', nargs='+', default=['lifestyle'], help="Social Groups to Analyse.")
    parser.add_argument('--language_1_path', type=str, default="social_groups/croatian_data_new.json", help="Language 1 to analyse.")
